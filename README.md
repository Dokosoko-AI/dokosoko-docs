...
Run commands from `dokosoko-docs`. The build publishes the canonical contracts from `../dokosoko-service/api/` at `/openapi.yaml`, `/provider-openapi.yaml`, and `/hooks-openapi.yaml`.
